...
au_id varchar(25) not null primary key,
au_lname varchar(25),
au_fname varchar(25),
phone varchar(15),
address varchar(50),
...
insert into titles values('PS2091', 'Is Anger the Enemy?', 'psychology', '0736', $10.95,$227500, 12, 2045,'Carefully researched study of the effects of strong emotions on the body. Metabolic charts included.','06/15/91')
...
title_id varchar(20) FOREIGN KEY references titles(title_id),
au_ord int,
royaltyper varchar(10)
)
